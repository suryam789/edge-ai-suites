...
public:
  struct Intrinsics
  {
    ...
    float ppy;  /**< Vertical coordinate of the principal point of the image,
                     as a pixel offset from the top edge */
    float fx;   /**< Focal length of the image plane, as a multiple of pixel width */
    float fy;   /**< Focal length of the image plane, as a multiple of pixel height */
    // rs2_distortion model;  /**< Distortion model of the image */

    Intrinsics() : width(0), height(0), ppx(0), ppy(0), fx(0), fy(0) {}

    Intrinsics(
      int width_, int height_, float ppx_, float ppy_, float fx_, float fy_,
    ...
    {
      Eigen::Matrix4f K;
      K << fx, 0, ppx, 0, 0, fy, ppy, 0, 0, 0, 1, 0, 0, 0, 0, 1;
      return K;
    }
  ...
  void setIntrinsics(
    const int height, const int width, const float ppx, const float ppy, const float fx,
    const float fy)
  {
  ...
  struct Intrinsics getScaledIntrinsics()
  {
