...
def generate_server_description():
    ...
    ld_list = [
        ...
        DeclareLaunchArgument(name='save_map_path', default_value='""'),
        DeclareLaunchArgument(name='save_traj_folder', default_value='""'),
        DeclareLaunchArgument(name='load_map_path', default_value='"./map/map.msg"'),
        DeclareLaunchArgument(name='server_mode', default_value='localization'),
...
def generate_tracker_description():
    ...
    ld_list = [
        ...
        DeclareLaunchArgument(name='tracker_log_level', default_value='info'),
        DeclareLaunchArgument(name='enable_fast_mapping', default_value='false'),
        ...
        DeclareLaunchArgument(name='octree_store_path', default_value='""'),
        DeclareLaunchArgument(name='traj_store_path', default_value='"./traj/"'),
        DeclareLaunchArgument(name='octree_load_path', default_value='"./map/octree.bin"'),
        DeclareLaunchArgument(name='odom_frame', default_value='odom'),
        DeclareLaunchArgument(name='slam_mode', default_value='localization'),
