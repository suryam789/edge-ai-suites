...
def generate_turtlebot_sim_description():
    tb3_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory('nav2_bringup_collab'),
    ...
    ld_list = [
        DeclareLaunchArgument(
            ...
            default_value=os.path.join(bringup_dir, 'rviz/nav2_mapping_view.rviz'),
        ),
...
def generate_server_description():
    server_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('univloc_server'), 'launch/server.launch.py')
        ),
        launch_arguments={
    ...
    ld_list = [
        ...
        DeclareLaunchArgument(name='save_map_path', default_value='"./map/map.msg"'),
        DeclareLaunchArgument(name='save_traj_folder', default_value='"./traj/"'),
        DeclareLaunchArgument(name='load_map_path', default_value='""'),
        DeclareLaunchArgument(name='server_mode', default_value='mapping'),
...
def generate_tracker_description():
    ...
    ld_list = [
        ...
        DeclareLaunchArgument(name='odom_tf_query_timeout', default_value='50.0'),
        ...
        DeclareLaunchArgument(name='image_frame', default_value='camera_rgb_optical_frame'),
        ...
        DeclareLaunchArgument(name='map_frame', default_value='map-0'),
        DeclareLaunchArgument(name='pub_tf_child_frame', default_value='odom'),
        DeclareLaunchArgument(name='queue_size', default_value='0'),
        DeclareLaunchArgument(name='tracker_rviz', default_value='false'),
        DeclareLaunchArgument(name='gui', default_value='false'),
        DeclareLaunchArgument(name='tracker_log_level', default_value='warning'),
        DeclareLaunchArgument(name='enable_fast_mapping', default_value='true'),
        DeclareLaunchArgument(name='zmin', default_value='0.3'),
        DeclareLaunchArgument(name='zmax', default_value='0.6'),
        DeclareLaunchArgument(name='depth_max_range', default_value='2.5'),
        DeclareLaunchArgument(name='octree_store_path', default_value='"./map/octree.bin"'),
        DeclareLaunchArgument(name='traj_store_path', default_value='"./traj/"'),
        DeclareLaunchArgument(name='octree_load_path', default_value='""'),
        DeclareLaunchArgument(name='odom_frame', default_value='odom'),
        DeclareLaunchArgument(name='slam_mode', default_value='mapping'),
        DeclareLaunchArgument(name='image_topic', default_value=image_topic_),
        DeclareLaunchArgument(name='depth_topic', default_value=depth_topic_),
        DeclareLaunchArgument(name='camera_info_topic', default_value=camera_info_topic_),
        DeclareLaunchArgument(name='depthmap_factor', default_value='1.0'),
        # Delay to launch tracker node after server node
